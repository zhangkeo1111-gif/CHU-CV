...
本项目是一个专为 **长安大学学生 / CHUer** 制作的 **LaTeX/XeLaTeX 中文简历模板**，可用于 **保研、求职、实习申请、竞赛报名** 以及各类材料投递。**请使用XeLaTeX编译，新手推荐使用Overleaf直接上传zip使用**。
...
Overleaf: overleaf gallery 不再接收cv模板，可直接上传项目-拖入zip使用，注意使用**XeLaTeX**编译。
